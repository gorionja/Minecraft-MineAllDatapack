...
summon minecraft:item ~ ~ ~ {Motion:[0.0d,0.2d,0.0d],Item:{id:"minecraft:obsidian",Count:1}}
...
execute if score obsidian MAD_InfDestFlg matches 1 run function orion.mineall:obsidian/detect_next_block_silk