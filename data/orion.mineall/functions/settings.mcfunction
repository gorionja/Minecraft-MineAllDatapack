...
execute if score gathering_items MAD_Setting matches 1 run tellraw @s ["",{"text":"[On] 〇 ","color":"green","clickEvent":{"action":"run_command","value":"/function orion.mineall:settings_gathering_items_on"}},{"text":" "},{"text":"[Off]    ","color":"red","clickEvent":{"action":"run_command","value":"/function orion.mineall:settings_gathering_items_off"}},{"text":"破壊したアイテムの自動収集"}]
execute if score gathering_items MAD_Setting matches 0 run tellraw @s ["",{"text":"[On]    ","color":"red","clickEvent":{"action":"run_command","value":"/function orion.mineall:settings_gathering_items_on"}},{"text":" "},{"text":"[Off] 〇 ","color":"green","clickEvent":{"action":"run_command","value":"/function orion.mineall:settings_gathering_items_off"}},{"text":"破壊したアイテムの自動収集"}]
